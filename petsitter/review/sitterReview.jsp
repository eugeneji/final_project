			...
			<div class="reviewDto col-sm-6 mt-5 p-1 rounded font" style="background-color: white; border-radius:10px; box-shadow: rgb(235, 235, 235) 1px 1px 12px 0px;">
				...
				<div class="sitterInfo col-sm-12 " >
					...
					<div class="col-sm-12 p-0">
						<div class="col-xs-8 font p-1">
							<img src="${pageContext.request.contextPath}/user/${review.user_idx}/profile.png" style="width:70px; height: 70px; border-radius: 10px;">
							${review.user_name += ' 회원님'}
						</div>
						<div class="col-xs-4 ">
					...
					<div class="col-sm-12 mt-5" style="height: 150px;">${review.review_content }</div>
