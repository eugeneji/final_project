...
<%@ include file="/WEB-INF/views/shopHeader.jsp"%>
<div class="container" style="width: 60%; padding-top: 100px;">
   <c:forEach var="c" items="${list }">
      <span>${c.cart_unit }</span>
   </c:forEach>
   ...
   <div class="card card-body">
      <table>
         ...
         <tr>
            <th>배송지</th>
            <td id="deAddr">${s_user.user_addr }
            </td>
            <td><a class="btn btn-light btn-sm" onclick="changeInfo()" style="float: right;">배송지 주소 변경</a></td>
         </tr>
         <tr>
            <th>상세주소</th>
            <td id="deDeAddr">${s_user.user_addr_detail }
            </td>
         </tr>
      </table>
   </div>
   ...
   <div class="card card-body">
      <table>
         <c:forEach var="item" items="${list }">
            <tr>
               <td>${item.item_name }&nbsp;&nbsp;${item.cart_unit }개
   ...
   <div class="card card-body">
      <table>
         ...
         <tr>
            <th>총 결제 금액</th>
            <td colspan="2"><h4>${paymentPrice }</h4> 원</td>
         </tr>
      </table>
   </div>
...
<div class=" popup1" id="chgI" style="display: none;">
      <table class="table">
         ...
         <tr>
          <td colspan="2">
          <input type="button" value="적용" onclick="goChangeInfo()">
...
function a2(){
	...
	var addr = document.getElementById("deAddr").innerHTMLs;
