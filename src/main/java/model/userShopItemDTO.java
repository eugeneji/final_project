package more.usershopitem.model;

import java.sql.Date;

public class userShopItemDTO {
	...
	private int wish;
	public userShopItemDTO() {
		super();
	}
	public userShopItemDTO(int item_idx, String item_name, String cate_code, int item_price, String item_info,
			String item_mainimg, int item_stock, String item_regid, String item_regdate, String item_tf,
			String cate_parent, String rnum, int star_total, double star_avg, int wish) {
		super();
