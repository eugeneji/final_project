...
function param() {
	var user_idx=document.getElementById('userid').value;
}
</script>
</head>
<body>
...
<div class='container' style="padding-top: 150px;">
	<div class="row">
		<div class="col-xs-6 col-md-4">
			 <div class="mypage">
		        <h2>My Menu</h2>
		        <input type="hidden" value="${user_idx}" id="userid">
		              <ul class="my_ul">
		                <li><a href="javascript:open('my_one')" style="color:#495057;">내정보</a>
		                	<ul id="my_one">
		                		<li>&nbsp;&nbsp;<a href="myInformation.do?user_idx=${user_idx}" style="color:#495057;">내 정보</a></li>
