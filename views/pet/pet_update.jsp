...
function pet_update(){
	...
	var pet_kind = document.getElementById('pet_kind').value;
...
<div id="bg_black"></div>
<div id="upload_photo" style="font-family: 'Jua', sans-serif;">
...
<section class="col-xs-12 col-sm-12 col-md-12" id="pet_register_form" style="margin: 0px auto; width: 600px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.35); border-radius: 15px;">
		<h1 style="text-align: center; margin-top: 20px;">반려동물 수정</h1>
	...
	<form id="pet_register_data" class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 30px; height: 100%;" action="pet_register_com.do" method="post">
		<div id="pet_name_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<input type="text" name="pet_name" id="pet_name" value="${dto.pet_name}">
			</div>
		</div>
		<div id="pet_sex_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<div class="col-xs-6 col-sm-6 col-md-6"><input id="radio_male" type="radio" name="pet_sex" value="male" ${dto.pet_type=="male"? "checked":""}><label style="margin-bottom: 0px;" for="radio_male">남자</label></div>
				<div class="col-xs-6 col-sm-6 col-md-6"><input id="radio_female" type="radio" name="pet_sex" value="female" ${dto.pet_type!="male"? "checked":""}><label style="margin-bottom: 0px;" for="radio_female">여자</label></div>
			</div>
		...
		<div id="pet_type_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<div class="col-xs-6 col-sm-6 col-md-6"><input id="radio_dog" type="radio" name="pet_type" value="dog" ${dto.pet_type=="dog"? "checked":""}><label style="margin-bottom: 0px;" for="radio_dog">강아지</label></div>
				<div class="col-xs-6 col-sm-6 col-md-6"><input id="radio_cat" type="radio" name="pet_type" value="cat" ${dto.pet_type!="dog"? "checked":""}><label style="margin-bottom: 0px;" for="radio_cat">고양이</label></div>
			</div>
		</div>
		<div id="pet_kind_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<input type="text" name="pet_kind" id="pet_kind" value="${dto.pet_kind}">
			</div>
		</div>
		<div id="pet_birth_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<input type="date" name="pet_birth" id="pet_birth" value="${dto.pet_birth}">
			</div>
		</div>
		<div id="pet_neuter_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<div class="col-xs-6 col-sm-6 col-md-6"><input id="radio_done" type="radio" name="pet_neuter" value="done" ${dto.pet_neuter=="done"? "checked":""}><label style="margin-bottom: 0px;" for="radio_done">했어요</label></div>
				<div class="col-xs-6 col-sm-6 col-md-6"><input  id="radio_notdone" type="radio" name="pet_neuter" value="notdone" ${dto.pet_neuter!="done"? "checked":""}><label style="margin-bottom: 0px;" for="radio_notdone">안 했어요</label></div>
			</div>
		</div>
		<div id="pet_weight_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px;">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				<input type="number" id="pet_weight" style="width: 80%;" value="${dto.pet_weight }"><span>kg</span>
			</div>
		</div>
		<div id="submit_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px; margin-bottom: 10px;">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<input type="button" onclick="pet_update();" style=" width: 100%; font-size: 17px;" value="수정하기">
			</div>
		</div>
		<div id="delete_form" class="col-xs-12 col-sm-12 col-md-12" style="margin:0px auto; height: 50px; line-height: 50px; margin-bottom: 10px;">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<input type="button" onclick="delete_pet('${dto.pet_idx}');" style="background-color:red; color: black;  width: 100%; font-size: 17px;" value="삭제하기">
			</div>
		</div>
	</form>
</section>
