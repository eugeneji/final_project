...
<head>
   ...
   ================================================== -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
 	...
 	<!-- CSS
   ================================================== -->
   <link rel="stylesheet" href="css/test/base.css">
   <link rel="stylesheet" href="css/test/vendor.css">  
   <link rel="stylesheet" href="css/test/main.css">  

   <!-- script
   ================================================== -->
	<script src="js/test/modernizr.js"></script>
	<script src="js/test/pace.min.js"></script>
...
<body id="top">
   ...
   <!-- Java Script
   ================================================== --> 
   <script src="js/test/jquery-2.1.3.min.js"></script>
   <script src="js/test/plugins.js"></script>
