...
function closeModal_forAN(){
	if(document.getElementById('detail_img_modal').style.display == 'block'){
		document.getElementById('detail_img_modal').style.display = 'none'
	}else if(document.getElementById('walk_detail_modal').style.display != 'none'){
		        	...
		        	for(var i=0; i<data.stats_list.length; i++){
		            	...
		            	stats_form.innerHTML += 
		            		'<div class="col-xs-12 stats_list_item" onclick="getWalkDetail('+walk_idx+');">'+
			    				'<div class="col-xs-12" style="margin-bottom: 10px; padding: 0px; text-align: center;"><span style="font-size: 13px; margin-right: 15px;">'+walk_starttime+'</span><span style="color: #94b8ff; font-size: 13px;">'+walk_user_name+'</span></div>'+
		...
		$.ajax({
	        ...
	        success: function (data) {
	        	...
	        	document.getElementById('gauge_form').innerHTML =
	        		'<div class="GaugeMeter" data-percent="'+gauge_percent+'" data-size="150" data-width="7" data-color="#94b8ff" data-animationstep="1" style="margin: 0px auto;">'+
	        			'<div style="position: absolute; width:100px; margin: 26px;">'+
	        				...
	        				'<div style="text-align: center; font-size: 20px; font-weight: bold;">'+setFixDayCount(detail_min)+':'+setFixDayCount(detail_sec)+'</div>'+
	        				'<div style="text-align: center; font-size: 10px; color: #757575;">산책량 '+gauge_percent+'%</div>'+
	        			'</div>'+
	        		'</div>';
...
<div id="detail_img_modal" style="width: 100vw; height: 100vh; line-height: 100vh; display: none; padding: 3vw;z-index: 5; position: fixed; background-color: black;">
	...
	<img id="detail_img" style="width: 90%; vertical-align: middle; margin: 0px 5%;">
</div>
<div id="walk_detail_modal" style="width: 100vw; height: 100vh; display: none; z-index: 4; position: fixed; background-color: white;">
	...
	<div id="walk_detail_form">
		...
		<div class="row" id="detail_other_form" style=" margin-top:-100px;">
			<div class="col-xs-5" style="text-align: center; font-size:12px; color: #757575;">이동거리</div>
			<div class="col-xs-2"></div>
			<div class="col-xs-5" style="text-align: center;  font-size:12px; color: #757575;">소모 칼로리</div>
			<div id="detail_dis" class="col-xs-5" style="text-align: center; font-size:20px;">
			</div>
			<div class="col-xs-2"></div>
			<div id="detail_cal" class="col-xs-5" style="text-align: center;  font-size:20px;">
			</div>
		</div>
	</div>
</div>
	<div style="position: fixed; width: 100vw; z-index: 2;">
		<div class="col-xs-6" style="padding: 0px;">
...
<div class='container' style="color: #4b5f5a; font-family: 'Lato', Arial, sans-serif; padding-top: 50px;">
	<div id="background_content" style="width:100%; height: 100%;">
		<div class="row" style="margin: 20px auto;">
			<c:forEach var="list" items="${pet_list}" varStatus="i">
				<div class="col-xs-3" style="padding: 0px 10px;  height: 35px; line-height: 35px;" onclick="select_pet(${list.PET_IDX});">
					...
					<div style="width:100%; text-align: center; font-size: 14px; border-radius: 10px;">${list.PET_NAME}</div>
				</div>
			</c:forEach>
		</div>
		<div class="row" style="margin-bottom: 20px;">
			...
			<div id="extend_calendar" class="col-xs-12 extend_cal" style="margin: 0px auto; width: 100%; height: 25px; background-color: #E0E0E0; text-align: center;" onclick="extend_cal();"><input type="checkbox" id="extend_icon" style="display:none;"><i class="extendBt_down"style="display: inline-block; width:25px; height:25px; background-size: cover;">　</i></div>
		</div>
		...
		<div id="eat_chart_form" class="row" style="width: 100vw; overflow-x: hidden;">
			<div id="week_chart" style="margin:0px auto; width: 750px;"></div>
		</div>
		
		<div id="total_stats_form" class="row" style="width: 100%; height: 70px; padding: 0px; margin: 0px auto;">
		...
		<div id="stats_form" class="row" style="width: 100%; padding: 0px; margin: 0px auto;">
		</div>
	</div>
</div>
</c:if>
