...
window.onload= function(){
	...
	today_s = today.getFullYear()+''+((today.getMonth()+1)<10? '0'+(today.getMonth()+1):(today.getMonth()+1))+(today.getDate()<10? '0'+today.getDate():today.getDate());
	console.log(today_s);
	var temp = new Date();
	temp.setDate(today.getDate()+1);
	
	document.getElementById('pet_birth').valueAsDate = temp;
	document.getElementById('birth_year').innerHTML = today.getFullYear();
	document.getElementById('birth_month').innerHTML = today.getMonth()+1;
	document.getElementById('birth_date').innerHTML = today.getDate();
}
...
function addFiles(e){
	...
	document.getElementById('pet_photo').style.display = 'block';
  		document.getElementById('photo_plus').style.display = 'none';
...
function register(){
	...
	$.ajax({
		url: 'm_walk_app_petRegister_com.do',
   		method: 'POST',
        data: formData,
        processData: false,
   		contentType: false,
        success: function () {
        	Android.pet_setting_com("반려동물 등록되었습니다.");
        },
        error: function () {
        },
	});
...
<div id="contaner">
		<div class="col-xs-12" style="margin-top: 25px;">
			...
			<div id="pet_photo_form" style="width: 200px; height: 200px; line-height: 200px;  border-radius: 100%; margin: 0px auto; overflow: hidden; border-style: solid; text-align: center; border-width: 2px;" onclick="$('#uploadCam').click();">
				<i id="photo_plus" style="background: url('${pageContext.request.contextPath}/images/plus_icon.png');background-size: cover; vertical-align: middle; width: 40px;height: 40px; margin: 0px auto; display: inline-block; background-repeat: no-repeat;vertical-align: middle;">　</i>
				<img id="pet_photo" style="width:200px; height: 200px; display:none;"> 
			</div>
		</div>
		...
		<div class="col-xs-12">
			<div class="col-xs-12">
				<div style="border-bottom: solid; border-width: 2px; border-color: #94b8ff; height: 40px;">
					<input type="text" name="pet_name" placeholder="" style="font-size: 20px; border-style: none;">
				</div>
			</div>
		</div>
		<div id="pet_sex_form" class="col-xs-12" style="margin-top: 25px;">
			...
			<div class="col-xs-6">
				<input id="sex_male" class="radio_box" type="radio" name="pet_sex" value="male" style="display: none;" checked>
			...
			<div class="col-xs-6">
				<input id="sex_female" class="radio_box" type="radio" name="pet_sex" value="female" style="display: none;">
		...
		<div id="eat_kind_form" class="col-xs-12" style="margin-top: 25px;">
			...
			<div class="col-xs-6">
				<input id="type_dog" class="radio_box" type="radio" name="pet_type" value="dog" style="display: none;" checked>
			...
			<div class="col-xs-6">
				<input id="type_cat" class="radio_box" type="radio" name="pet_type" value="cat" style="display: none;">
		...
		<div class="col-xs-12">
			<div class="col-xs-12">
				<div style="border-bottom: solid; border-width: 2px; border-color: #94b8ff; height: 40px;">
					<input type="text" name="pet_kind" placeholder="" style="font-size: 20px; border-style: none;">
				</div>
			</div>
		</div>
		...
		<div class="col-xs-12">
			<div class="col-xs-12">
				<input id="pet_birth" type="date" name="pet_birth" style="visibility: hidden;" onchange="cal_change();">
		...
		<div id="eat_kind_form" class="col-xs-12" style="margin-top: 25px;">
			...
			<div class="col-xs-6">
				<input id="neuter_do" class="radio_box" type="radio" name="pet_neuter" value="done" style="display: none;" checked>
			...
			<div class="col-xs-6">
				<input id="neuter_notdo" class="radio_box" type="radio" name="pet_neuter" value="notdone" style="display: none;">
		...
		<div class="col-xs-12">
			<div class="col-xs-12">
				<div style="border-bottom: solid; border-width: 2px; border-color: #94b8ff; height: 40px;">
					<input type="number" name="pet_weight" placeholder="Kg" style="font-size: 20px; text-align:center; border-style: none;">
				</div>
			</div>
		</div>
		</form>
		
		<div class="col-xs-12" style="margin-top: 35px; height: 80px; line-height: 80px; background-color: #94b8ff; color: white; text-align: center;" onclick="register();">등록하기</div>
</div>
</body>